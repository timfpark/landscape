...
Tile.tileFromTileId = function(tileId) {
    ...
    tile.medianLatitude = (tile.latitudeNorth + tile.latitudeSouth) / 2.0;
    tile.medianLongitude = (tile.longitudeEast + tile.longitudeWest) / 2.0;
...
Tile.tileIdsForAllZoomLevels = function(tileId) {
    ...
    for (var zoom=Tile.MAX_ZOOM; zoom > Tile.MIN_ZOOM; zoom--) {
        var tileId = Tile.tileIdFromLatLong(tile.medianLatitude, tile.medianLongitude, zoom);
        tileIds.push(tileId);
    }
